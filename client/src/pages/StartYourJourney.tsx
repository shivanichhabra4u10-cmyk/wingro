...
/**
 * StartYourJourney component representing the diagnostic flow for users
...
const StartYourJourney: React.FC = () => {
  ...
  return (
    <div className="min-h-screen pb-16">
      {/* Hero/Header Section - blue background only here */}
      <section className="bg-gradient-to-r from-blue-900 to-indigo-800 rounded-xl p-8 md:p-12 text-white relative overflow-hidden mb-0 max-w-4xl mx-auto">
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-cyan-400">
            Breakthrough Your Growth Ceiling
          </h1>
          <h2 className="text-xl md:text-2xl font-semibold mb-5 text-blue-100">
            AI-powered expert matching for guaranteed growth outcomes
          </h2>
        ...
        {/* Visual elements for orb gradients */}
      ...
      {/* Main card sits below header, on light background */}
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-white rounded-xl shadow-lg p-8 mt-[-3rem] mb-8 relative z-10">
          {/* Progress Bar */}
